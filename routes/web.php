...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/feature1', action: [Feature1Controller::class, 'index'])->name('feature1.index');
    Route::post('/feature1/calculate', action: [Feature1Controller::class, 'calculate'])->name('feature1.calculate');
